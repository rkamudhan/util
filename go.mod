module github.com/rkamudhan/util
...
replace k8s.io/apimachinery => k8s.io/apimachinery v0.19.1-rc.0
...
replace k8s.io/code-generator => k8s.io/code-generator v0.19.1-rc.0

replace k8s.io/component-base => k8s.io/component-base v0.19.0

replace k8s.io/controller-manager => k8s.io/controller-manager v0.19.1-rc.0

replace k8s.io/cri-api => k8s.io/cri-api v0.19.1-rc.0
...
require k8s.io/kubernetes v1.19.0
